...
public class AdminInterface extends JFrame {
        ...
        searchButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    fetchDataFromDatabase("fillup_form", studentID);
                    fetchAdditionalDetailsFromDatabase("next_fillup_form", studentID);
    ...
    private void fetchDataFromDatabase(String sql, int studentID) {
        try {
    ...
    private void fetchAdditionalDetailsFromDatabase(String tableName, int studentID) {
        try {
            Connection connection = getConnection();
                ...
                int rowsAffectedFillupForm = preparedStatementFillupForm.executeUpdate();
                    ...
                    if (rowsAffectedFillupForm > 0) {
                        JOptionPane.showMessageDialog(
                                AdminInterface.this,
                                "Student deleted successfully from both tables.",
                                "Success",
                        ...
                        JOptionPane.showMessageDialog(
                                AdminInterface.this,
                                "Failed to delete student from one or both tables.",
                                "Error",
