...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2023 at 12:36 PM
...
INSERT INTO `fillup_form` (`srcode`, `studentID`, `firstname`, `lastname`, `middle`, `age`, `d_o_b`, `address`, `Phone_num`) VALUES
(2211111, 4, 'Chester Jeff', 'Arano', 'Ascona', 20, '2003-08-03', 'San Jose, Alitagtag', 9888888),
(2212345, 3, 'Kyle Matthew', 'Calingasan', 'Dela Pena', 20, '2003-09-13', 'Alitagtag, Batangas', 9999999),
(2233333, 6, 'Clark', 'Alisuag', 'Pogi', 20, '2003-11-13', 'Poblacion West, Alitagtag', 97777777),
(2266666, 8, 'Jose Mari', 'Chan', 'kun', 21, '2002-11-29', 'Manila, Philippines', 1234567890);
...
ALTER TABLE `next_fillup_form`
  ...
  ADD UNIQUE KEY `srcode_2` (`srcode`) USING BTREE;
...
ALTER TABLE `next_fillup_form`
  ...
  ADD CONSTRAINT `next_fillup_form_ibfk_2` FOREIGN KEY (`srcode`) REFERENCES `fillup_form` (`srcode`);
COMMIT;
